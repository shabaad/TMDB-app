                      ...
                      return ListView(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('Double tap image to favourite'),
                          ),
                           kHeight,
                          MainTitleCard(
                            title: "Released in the Past Year",
                            posterList: _releasedPastYear.sublist(0,_releasedPastYear.isEmpty ? 0 : 10),
                          ),
                          kHeight,
                          MainTitleCard(
                            title: "Trending Now",
                            posterList: _trending.sublist(0, _trending.isEmpty ? 0 : 10),
                          ),
                          kHeight,
                          NumberTitleCard(
                            postersList: _top10TvShow.sublist(0, _top10TvShow.isEmpty ? 0 : 10),
                          ),
                          kHeight,
                          MainTitleCard(
                            title: "Tense Dramas",
                            posterList: _tenseDramas.sublist(0,  _tenseDramas.isEmpty ? 0 : 10),
                          ),
                          kHeight,
                          MainTitleCard(
                            title: "South Indian Cinema",
                            posterList: _southIndian.sublist(0,  _southIndian.isEmpty ? 0 : 10),
                          ),
                        ],
                      );
                    },
